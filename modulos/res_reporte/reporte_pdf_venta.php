...
$mesf = $mes."-31";
	...
	$consulta=mysqli_query($conexion,sprintf("SELECT * FROM empre, fact_venta, cliente WHERE
...
?>
 ...
 <thead>
 	<tr><th colspan="35"><div><?php echo utf8_decode($filasEmpre['titular_rif_empre']." - ". $filasEmpre['nom_empre']);?></div></th></tr>
    <tr><th colspan="34"><div><?php echo $filasEmpre['rif_empre'];?></div></th></tr>
    <tr><th colspan="34"><div>Direcci&oacute;n: &nbsp;<?php echo utf8_decode($filasEmpre['dir_empre']);?></div></th></tr>
    <tr><th colspan="34"><div>Contribuyente <?php echo $filasEmpre['contri_empre'];?></div></th></tr>
    <tr><th colspan="34"><div>LIBRO DE VENTAS CORRESPONDIENTE AL MES DE <?php echo mesNum_Texto($mes);?></div></th></tr>
	<?php //funcion para convertir la fechaa mes en letras y ano?>
      <tr>
        <td colspan="20" rowspan="2"><b></b></td>
        <td class="titulo" colspan="1" rowspan="2"><div class="subTitulo">EXPORTACIONES</div></td>
        <td class="titulo" colspan="11"><div class="subTitulo">NACIONALES</div></td>
      ...
      <tr class="titulo">
        ...
        <td><div class="h">Fecha <br>del <br>Documento</div></td>
        <td><div class="h">N&deg; R.I.F. &oacute;<br />Cedula de <br />Identidad</div></td>
        <td><div class="h">Nombre &oacute; <br />Raz&oacute;n Social</div></td>
        <td><div class="h">Tipo <br />de <br />Cliente</div></td>
        
        <td class="cont_v"><div>Nro. de Planilla de Exportaci&oacute;n</div></td>
        <td class="cont_v"><div>Nro. del Expediente de Exportaci&oacute;n</div></td>
        ...
        <td class="cont_v"><div>Nro. del Documento</div></td>
        <td class="cont_v"><div>Nro. de Control</div></td>
        <td class="cont_v"><div>Registro de Maquina Fiscal</div></td>
        <td class="cont_v"><div>Nro. de Reporte Z</div></td>
        <td class="cont_v"><div>Nro. de Nota de Debito</div></td>
        <td class="cont_v"><div>Nro. de Nota de Credito</div></td>
        <td class="cont_v"><div>Tipo de Transacci&oacute;n</div></td><!--tipo Venta-->
        
        <td class="cont_v"><div>Nro. de Documento <br>afectado</div></td>
        
        <td class="cont_v"><div>Nro. de <br />Comprob <br />de <br />Retenci&oacute;n</div></td>
        <td class="cont_v"><div>Fecha de <br />Aplicaci&oacute;n <br />de <br />Retenci&oacute;n</div></td>
                
        <!--EXPORTACIONES-->
	    <td class="cont_v"><div>Ventas Exportacion Exentas /Exoneradas</div></td>
        <!--nacional-->
        <td class="cont_v"><div>Total de Venta  Nacional incluyendo el IVA</div></td>
        <td class="cont_v"><div>Ventas sin derecho a credito IVA</div></td>
        <td class="cont_v"><div>Ventas Exentas</div></td>
        <td class="cont_v"><div>Ventas Exoneradas</div></td>
        <td class="cont_v"><div>Ventas no Sujetas</div></td>
    ...
    do{
			//CONSULTAS RELACIONALES
				...
				$consultaNota = mysqli_query($conexion,sprintf("SELECT * FROM notas_cd_venta, fact_venta WHERE fact_venta.id_fact_venta = notas_cd_venta.id_fact_venta AND notas_cd_venta.id_fact_venta = '%s'",$filas['id_fact_venta']));
...
<table cellspacing="0" class="tabla1 table">
  <tbody>
	<tr class="titulo">
    	<td colspan="5"><div class="subTitulo">RESUMEN DE VENTAS DEl MES DE <?php echo mesNum_Texto($mes);?></div></td>
    </tr>
    <tr class="titulo">
