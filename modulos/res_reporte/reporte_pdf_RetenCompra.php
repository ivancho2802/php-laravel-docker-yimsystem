...
?>
 ...
 <thead>
 	<tr><th colspan="14" class="tabla_header"><span style="font-size:18px;">
	<?php echo utf8_decode($filasEmpre['titular_rif_empre']." - ". $filasEmpre['nom_empre']);?>
                                        	  </span></th></tr>
    <tr><th colspan="14" class="tabla_header"><div>&nbsp;</div></th></tr><!--NO QUITE EL DIV ES EL QUE HACE PONER LA TABLA AL 100-->
    <tr>
    ...
    <!--
    <tr>
    	<th colspan="12" class="tabla_header">Contribuyente <?php //echo $filas['contri_empre'];?></th>
    </tr>
    <tr><th colspan="4" class="tabla_header">Comprobantes de Retencion: <?php //echo $_POST['num_compro_reten'];?></th></tr>
    -->
    <tr>
    	<th>&nbsp;</th>
    </tr>
