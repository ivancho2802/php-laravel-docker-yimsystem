...
function mConsulFact(str){
	...
	url = '../<?php //res_nfact_afectadaecho $extra?>modales/fact_c/m_b_fact_c_det.php';
...
<?php 
	...
	include_once("../../modales/fact_c/m_b_fact_c.php");
          ...
          <div class="col-xs-4 col-md-4 col-lg-4" id="resTipoDoc">
            ...
            <span class="input-group">
                ...
                <span class="input-group-btn">
                	<button type="button" style="display:none" class="btn btn-primary" name="btn_b_nfact_afectada" id="btn_b_nfact_afectada" title="Buscar Factura" data-toggle="modal" data-target="#busFact">
