...
$sql=sprintf("UPDATE fact_compra SET 
									 id_fact_compra = '%s',
...
////////////////////////////////////////////////////////////
	...
	$sql_compra = mysqli_query($conexion,sprintf("SELECT * FROM compra WHERE compra.fk_fact_compra = '%s'",
	...
	if($res_sql_compra){
		do{
			...
			$sqlInventActual = mysqli_query($conexion,sprintf("SELECT * FROM inventario WHERE 
													codigo = '%s'",
													$prod_compra));
...
////////////////////////////////////////////////////////			
			...
			$sqlUpdateRevetInven = sprintf("UPDATE inventario SET stock ='%s' WHERE 
									...
									$cant_final, 
									$prod_compra);
			$UpdateRevetInven = mysqli_query($conexion,$sqlUpdateRevetInven)or
...
////////////////////////////////////////////////////////
			...
			$DeleteRevetCompra = mysqli_query($conexion,$sqlDeleteRevetCompra)or
...
//////////////////////////////////////////////////////
	...
	$sqlDeleteRevetRegInv = sprintf("DELETE FROM reg_inventario WHERE  
							fk_fact_cv = '%s' AND
							tipo = 'compra'",
							$_POST['id_fact_compra']);
	$DeleteRevetRegInv = mysqli_query($conexion,$sqlDeleteRevetRegInv)or
