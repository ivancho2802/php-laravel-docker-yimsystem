...
function agreInput(numCampos){
	...
	var i = parseInt(numCampos) + 1;
		...
		icosto.setAttribute("value","0.00");
		icosto.setAttribute("placeholder","0.00 Clic aqui");
		icosto.setAttribute("onBlur","fcalculo()");
		icosto.setAttribute("class","form-control btn-primary active");
		/////////////
...
//		icantidad.setAttribute("onclick","val_cv_fech(document.form1.fecha_fact_compra.value, 'fecha_fact_compra')");
		...
		celda3.appendChild(icosto);celda3.appendChild(br);celda3.appendChild(spaninputgroupB);
		celda4.appendChild(spaninputgroup);
		celda5.appendChild(itipoCompra);
		celda6.setAttribute("align","center");celda6.appendChild(bBorrarFila);
...
<div class="bs-example" id="modificarCompra">
    <div class="">
    	<h1 class="bd-title">Modificar Compra</h1>    
        
    </div>
	<div class="bs-marco-form">
	  <form id="form1" name="form1" method="post" action="recibirmCompra.php">
      	<div class="row">
        ...
        <input type="hidden" name="empre_cod_empre" value="<?php echo $filas["cod_empre"]?>"/><!--el id de la empresa actual del sistema-->
          ...
          <div class="col-xs-4 col-md-4 col-lg-4" id="resTipoDoc">
            ...
            <span class="input-group">
                <input class="form-control" name="nfact_afectada" id="nfact_afectada" type="hidden" />
                <span class="input-group-btn">
        ...
        <hr id="res_modificarCompra" class="featurette-divider">
        <div class="row">
          <div class="col-xs-12 col-md-12 col-lg-12" id="res_consulTablaProd">
           <table class="table_nada table table-bordered table_black">
              <thead id="resCompra">
                ...
                <td>
                <input class="form-control" name="costo1" required="" type="number" min="0" step="0.0000001" value="" placeholder="0.00 Clic aqui" onblur="fcalculo()"/>
                <br>
                <span class="input-group">
                ...
                <td>
                <span class="input-group">
                    <input class="form-control" name="cantidad1" required="" type="number" min="0" onblur="fcalculo()" value=""/>
                ...
                <td>
                <select name="tipoCompra1" id="tipoCompra1" class="selectpicker form-control" data-style="btn-primary" onchange="fcalculo(1)">
        ...
        <div class="row">
          ...
          <div class="col-xs-4 col-md-4 col-lg-4">
        	...
        	<input type="text" class="form-control" name="tot_iva" id="tot_iva" value="0" size="20" readonly="readonly"/>
          </div>
        </div><!--row-->
        ...
        <div class="row">
          ...
          <div class="col-xs-4 col-md-6 col-lg-6">
			...
			<input type="text" class="form-control" name="mtot_iva_compra" id="mtot_iva_compra" value="0" readonly="readonly"/>
          </div>
        </div><!--row-->
        <hr id="res_modificarCompra2" class="featurette-divider">
        <div class="row">
          <div class="col-xs-12 col-md-12 col-lg-12">
          	<button type="submit" class="btn btn-lg btn-success col-xs-12 col-md-12 col-lg-12">Modificar Compra</button>
