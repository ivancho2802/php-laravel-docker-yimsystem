...
{		
		...
		//realizo el sql
		$c_mm_prov=mysqli_query($conexion,sprintf("SELECT * FROM proveedor WHERE
									proveedor.rif = '%s'",
									$rif_prov));
...
<label>
    ...
    <div class="row">
        ...
        <label class="col-md-6 col-lg-6" id="res_rif">
            <span id="cont_rif">
            R.I.F. / Cedula<br>
            <input type="text" class="form-control" name="rif_m_m_prov" id="rif_m_m_prov" pattern="[JVEGP][0-9]{8}" lang="si-rif" value="<?php echo $f_mm_prov['rif']?>"/>
            <input type="hidden" id="rif_m_m_prov_vie" value="<?php echo $f_mm_prov['rif']?>"/>
        ...
        <label class="col-md-6 col-lg-6">
            ...
            <span class="input-group">
                <span id="resRifC"> </span>
                    <input type="text" class="form-control" name="nombre_m_m_prov" id="nombre_m_m_prov" pattern="[A-Za-z ñáéíóú ÑÁÉÍÓÚ 0-9]*" onBlur="javascript:this.value=this.value.toUpperCase();" lang="si-general" value="<?php echo $f_mm_prov['nombre']?>" required>
    ...
    <div class="row">
        <label class="col-md-6 col-lg-6">
            Telefono:<br>
            <input type="text" class="form-control" name="telefono_m_m_prov" id="telefono_m_m_prov" min="999999999" max="999999999999" pattern="[0][42][127][246][0-9]{7}" lang="no-telf" value="<?php echo $f_mm_prov['telefono']?>" required>
            <span class="help-block">Formato: 04161234567</span>
        </label>
        <label class="col-md-6 col-lg-6">
            Direcci&oacute;n:<br />
            <input class="form-control" type="text" name="direccion_m_m_prov" id="direccion_m_m_prov" value="<?php echo $f_mm_prov['direccion']?>" lang="no-general" required>
        </label>
    </div><!--row-->
</label>