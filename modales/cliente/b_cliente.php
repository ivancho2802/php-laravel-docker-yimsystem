...
require_once($extra.'includes_SISTEM/include_login.php');
	...
	if(isset($_POST['cliente']))
	{
		if($_POST['cliente'] == " "){
		//realizo el sql
		$consulta=mysqli_query($conexion,sprintf("SELECT * FROM cliente"));
		...
		//realizo el sql
		$consulta=mysqli_query($conexion,sprintf("SELECT * FROM cliente WHERE
...
<?php
		...
		if($total_consulta >= 1){
            ...
            <tr>
                ...
                <td><input type="button" class="btn btn-success" value="Agregar y Seleccionar Cliente" data-dismiss="modal" data-toggle="modal" data-target="#nueCliente"></td>
            </tr>
            <?php    
		}
?>		
