  ...
  <div class="container-fluid {{ (Request::is('static-sign-up') ? 'container' : 'container-fluid') }}">
    ...
    <div class="collapse navbar-collapse" id="navigation">
      ...
      <ul class="navbar-nav d-lg-block d-none">
        <li class="nav-item">
          <!-- <a href="#/product/soft-ui-dashboard-laravel" target="_blank" class="btn btn-sm btn-round mb-0 me-1 bg-gradient-{{ (Request::is('static-sign-up') ? 'light' : 'dark') }}">Free download</a> -->
        </li>
      </ul>
    </div>
  </div>
