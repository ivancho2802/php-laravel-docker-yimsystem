<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-end me-3 rotate-caret " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
        ...
        <span class="ms-1 font-weight-bold">Yim Sistema Contable</span>
    </a>
  </div>
  ...
  <div class="sidenav-footer mx-3 ">
    ...
    <a class="btn bg-gradient-primary mt-4 w-100" href="#/product/soft-ui-dashboard-pro-laravel" target="_blank" type="button">Upgrade to pro</a>
  </div>
</aside>
