    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-8 mx-auto text-center mb-4 mt-2">
          ...
          <a href="https://twitter.com/ivancho2802" target="_blank" class="text-secondary me-xl-4 me-4">
            <span class="text-lg fab fa-twitter" aria-hidden="true"></span>
          </a>
          <a href="https://www.instagram.com/ivancho2802/" target="_blank" class="text-secondary me-xl-4 me-4">
            <span class="text-lg fab fa-instagram" aria-hidden="true"></span>
          </a>
          <!-- <a href="#" target="_blank" class="text-secondary me-xl-4 me-4">
                  <span class="text-lg fab fa-pinterest" aria-hidden="true"></span>
              </a> -->
          <a href="https://github.com/ivancho2802" target="_blank" class="text-secondary me-xl-4 me-4">
      ...
      <div class="row">
        <div class="col-8 mx-auto text-center mt-1">
          <p class="mb-0 text-secondary">
            ...
            <div class="d-inline-flex phpdebugbar-header"></div>
          </p>
          <!-- 
            ...
            <p class="mb-0 text-secondary">
              ...
              <a style="color: #252f40;" href="#" class="font-weight-bold ml-1" target="_blank">TIDIAZ</a>
              &
              <a style="color: #252f40;" href="#" class="font-weight-bold ml-1" target="_blank">Yim</a>.
            </p> -->
        </div>
      </div>
      @endif
