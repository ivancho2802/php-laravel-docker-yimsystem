            ...
            <div class="row">
              <label class="col-md-4 col-lg-4" id="res_num_compro_reten">
                ...
                <span id="cont_num_compro_reten">
                  <!-- la validacion de exiystecia esta babajo -->
                  <input type="text" class="form-control" name="num_compro_reten" id="num_compro_reten" lang="si-num_compro_reten"  required>
                </span>
              </label>
              <label class="col-md-4 col-lg-4">
...
<script>
  $(document).ready(function() {
    ...
    $('#num_compro_reten').on('input', function() {
      ...
      validarRepetido('fact_ventas', 'num_compro_reten', this.value, 'num_compro_reten')
    });
  });
